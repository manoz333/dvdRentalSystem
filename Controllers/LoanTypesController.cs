...
namespace groupCW.Controllers
{
    public class LoanTypesController : Controller
    {
        ...
        {
              return _context.LoanTypes != null ? 
                          View(await _context.LoanTypes.ToListAsync()) :
                          Problem("Entity set 'ApplicationDbContext.LoanTypes'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.LoanTypes'  is null.");
            }
            var loanType = await _context.LoanTypes.FindAsync(id);
            if (loanType != null)
            {
        ...
        {
          return (_context.LoanTypes?.Any(e => e.LoanTypeNumber == id)).GetValueOrDefault();
        }
    }
}
